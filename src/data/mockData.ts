...
export const TOP_RANKING_DATA: ParticipantScoreItem[] = [
  {
    ...
    regNumber: 'KIPK-2026-0012',
    firstChoice: 'S1 Ilmu Hukum',
    secondChoice: 'S1 Manajemen',
    utbkScore: 92.5,
    interviewScore: 94.0,
    surveyScore: 90.0,
    finalScore: 92.35,
  ...
  },
  {
    ...
    regNumber: 'KIPK-2026-0045',
    firstChoice: 'S1 Informatika',
    secondChoice: 'S1 Sistem Informasi',
    utbkScore: 90.0,
    interviewScore: 91.5,
    surveyScore: 93.0,
    finalScore: 91.50,
  ...
  },
  {
    ...
    regNumber: 'KIPK-2026-0089',
    firstChoice: 'S1 Akuntansi',
    secondChoice: 'S1 Manajemen',
    utbkScore: 88.0,
    interviewScore: 92.0,
    surveyScore: 89.0,
  ...
  },
  {
    ...
    regNumber: 'KIPK-2026-0104',
    firstChoice: 'S1 Teknik Sipil',
    secondChoice: 'S1 Informatika',
    utbkScore: 86.5,
    interviewScore: 89.0,
    surveyScore: 92.0,
    finalScore: 89.15,
  ...
  },
  {
    rank: 5,
    name: 'Budi Santoso',
    regNumber: 'KIPK-2026-0156',
    firstChoice: 'S1 Agroteknologi',
    secondChoice: 'S1 Agribisnis',
    utbkScore: 84.0,
    interviewScore: 90.0,
    surveyScore: 91.0,
    finalScore: 88.50,
  ...
  },
  {
    ...
    regNumber: 'KIPK-2026-0210',
    firstChoice: 'S1 Ilmu Komunikasi',
    secondChoice: 'S1 Administrasi Publik',
    utbkScore: 85.0,
    interviewScore: 87.0,
    surveyScore: 88.0,
    finalScore: 86.70,
  ...
  },
  {
    rank: 7,
    name: 'Fikri Alamsyah',
    regNumber: 'KIPK-2026-0245',
    firstChoice: 'S1 Pendidikan Bahasa Inggris',
    secondChoice: 'S1 Ilmu Hukum',
    utbkScore: 82.0,
    interviewScore: 88.0,
    surveyScore: 85.0,
    finalScore: 85.30,
  ...
  },
  {
    ...
    regNumber: 'KIPK-2026-0312',
    firstChoice: 'S1 Manajemen',
    secondChoice: 'S1 Akuntansi',
    utbkScore: 80.0,
    interviewScore: 86.0,
    surveyScore: 87.0,
    finalScore: 84.50,
  ...
  },
  {
    ...
    regNumber: 'KIPK-2026-0378',
    firstChoice: 'S1 Teknik Elektro',
    secondChoice: 'S1 Informatika',
    utbkScore: 83.0,
    interviewScore: 81.0,
    surveyScore: 84.0,
  ...
  },
  {
    rank: 10,
    name: 'Nurul Khotimah',
    regNumber: 'KIPK-2026-0401',
    firstChoice: 'S1 Administrasi Publik',
    secondChoice: 'S1 Ilmu Hukum',
    utbkScore: 80.0,
    interviewScore: 90.0,
    surveyScore: 70.0,
...
export const INITIAL_PARTICIPANTS: Participant[] = [
  {
    ...
    name: 'Ahmad Fauzan Pratama',
    nisn: '0065412891',
    nik: '1771011204060001',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 1,
    firstChoiceProdiName: 'S1 Ilmu Hukum',
    secondChoiceProdiId: 5,
    secondChoiceProdiName: 'S1 Manajemen',
    schoolOrigin: 'SMAN 1 Kota Bengkulu',
    schoolType: 'SMA',
    schoolMajor: 'MIPA',
    graduationYear: 2026,
    phone: '081273849102',
    email: 'ahmad.fauzan@gmail.com',
    address: 'Jl. Danau Dendam Tak Sudah No. 42, RT 08/RW 03',
    city: 'Kota Bengkulu',
    province: 'Bengkulu',
    desil: 'Desil 1',
    parentName: 'M. Yusuf',
    parentIncome: 950000,
    parentJob: 'Buruh Bangunan',
    familyDependents: 4,
    ...
    rank: 1,
    notes: 'Kondisi rumah sangat layak prioritas KIP-K. Dinding papan belum diplester.',
    createdAt: '2026-06-02 09:15:00',
    updatedAt: '2026-08-20 14:10:00'
  },
  {
    id: 2,
    regNumber: 'KIPK-2026-0045',
    name: 'Siti Nur Aisyah',
    nisn: '0068923411',
    nik: '1703054511060002',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 2,
    firstChoiceProdiName: 'S1 Informatika',
    secondChoiceProdiId: 6,
    secondChoiceProdiName: 'S1 Akuntansi',
    schoolOrigin: 'SMKN 1 Bengkulu',
    schoolType: 'SMK',
    schoolMajor: 'Rekayasa Perangkat Lunak',
    graduationYear: 2026,
    phone: '082188992314',
    email: 'sitinur.aisyah@gmail.com',
    address: 'Desa Giri Mulya RT 02/RW 01',
    city: 'Bengkulu Utara',
    province: 'Bengkulu',
    desil: 'Desil 1',
    parentName: 'Bambang Irawan',
    parentIncome: 800000,
    parentJob: 'Petani Karet Harian',
    familyDependents: 5,
    documentStatus: 'Lengkap',
    utbkScore: 90.0,
    interviewScore: 91.5,
    ...
    selectionStatus: 'Lulus',
    rank: 2,
    notes: 'Pemegang KIP Sekolah & SKTM resmi dari kantor desa.',
    createdAt: '2026-06-03 10:20:00',
    updatedAt: '2026-08-20 14:12:00'
  },
  {
    id: 3,
    regNumber: 'KIPK-2026-0089',
    name: 'Rian Hidayat Saputra',
    nisn: '0057812903',
    nik: '1702011908050003',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 6,
    firstChoiceProdiName: 'S1 Akuntansi',
    secondChoiceProdiId: 5,
    secondChoiceProdiName: 'S1 Manajemen',
    schoolOrigin: 'SMAN 1 Curup, Rejang Lebong',
    schoolType: 'SMA',
    schoolMajor: 'IPS',
    graduationYear: 2025,
    phone: '085267123901',
    email: 'rian.hidayat@yahoo.com',
    address: 'Jl. Sukowati No. 15, Curup',
    city: 'Rejang Lebong',
    province: 'Bengkulu',
    desil: 'Desil 2',
    parentName: 'Sudirman',
    parentIncome: 1200000,
    parentJob: 'Pedagang Keliling',
    familyDependents: 3,
    documentStatus: 'Lengkap',
    utbkScore: 88.0,
    interviewScore: 92.0,
    ...
    selectionStatus: 'Lulus',
    rank: 3,
    notes: 'Prestasi olimpiade akuntansi tingkat kabupaten.',
    createdAt: '2026-06-05 11:30:00',
    updatedAt: '2026-08-20 14:15:00'
  },
  {
    id: 4,
    regNumber: 'KIPK-2026-0104',
    name: 'Dinda Permata Sari',
    nisn: '0061294801',
    nik: '1771025501060004',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 3,
    firstChoiceProdiName: 'S1 Teknik Sipil',
    secondChoiceProdiId: 2,
    secondChoiceProdiName: 'S1 Informatika',
    schoolOrigin: 'SMAN 2 Kota Bengkulu',
    schoolType: 'SMA',
    schoolMajor: 'MIPA',
    graduationYear: 2026,
    phone: '081379012455',
    email: 'dinda.permata@gmail.com',
    address: 'Jl. Pariwisata Pantai Berkas No. 03',
    city: 'Kota Bengkulu',
    province: 'Bengkulu',
    desil: 'Desil 2',
    parentName: 'Hasan Basri',
    parentIncome: 1100000,
    parentJob: 'Nelayan Tradisional',
    familyDependents: 4,
    documentStatus: 'Lengkap',
    utbkScore: 86.5,
    interviewScore: 89.0,
    ...
    selectionStatus: 'Lulus',
    rank: 4,
    notes: 'Ayah nelayan perahu kecil, kondisi ekonomi sangat terbatas.',
    createdAt: '2026-06-06 14:00:00',
    updatedAt: '2026-08-20 14:18:00'
  },
  {
    id: 5,
    regNumber: 'KIPK-2026-0156',
    name: 'Budi Santoso',
    nisn: '0059912034',
    nik: '1701042305050005',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 7,
    firstChoiceProdiName: 'S1 Agroteknologi',
    secondChoiceProdiId: 8,
    secondChoiceProdiName: 'S1 Agribisnis',
    schoolOrigin: 'SMAN 1 Manna, Bengkulu Selatan',
    schoolType: 'SMA',
    schoolMajor: 'MIPA',
    graduationYear: 2025,
    phone: '085378290123',
    email: 'budi.santoso@gmail.com',
    address: 'Jl. Padang Panjang RT 04, Manna',
    city: 'Bengkulu Selatan',
    province: 'Bengkulu',
    desil: 'Desil 1',
    parentName: 'Suwito',
    parentIncome: 900000,
    parentJob: 'Buruh Tani Sawit',
    familyDependents: 6,
    documentStatus: 'Lengkap',
    utbkScore: 84.0,
    interviewScore: 90.0,
    ...
    selectionStatus: 'Lulus',
    rank: 5,
    notes: 'Orang tua sakit menahun, tanggungan 6 orang.',
    createdAt: '2026-06-08 08:45:00',
    updatedAt: '2026-08-20 14:20:00'
  },
  {
    id: 6,
    regNumber: 'KIPK-2026-0210',
    name: 'Maya Tri Astuti',
    nisn: '0063412098',
    nik: '1771036012060006',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 10,
    firstChoiceProdiName: 'S1 Ilmu Komunikasi',
    secondChoiceProdiId: 9,
    secondChoiceProdiName: 'S1 Administrasi Publik',
    schoolOrigin: 'MAN 1 Model Bengkulu',
    schoolType: 'MA',
    schoolMajor: 'Keagamaan / IPS',
    graduationYear: 2026,
    phone: '081271120044',
    email: 'maya.astuti@gmail.com',
    address: 'Jl. Cendrawasih No. 18, Kebun Beler',
    city: 'Kota Bengkulu',
    province: 'Bengkulu',
    desil: 'Desil 3',
    parentName: 'Iskandar',
    parentIncome: 1400000,
    parentJob: 'Tukang Ojek Pangkalan',
    familyDependents: 3,
    documentStatus: 'Lengkap',
    utbkScore: 85.0,
    interviewScore: 87.0,
    ...
    selectionStatus: 'Lulus',
    rank: 6,
    notes: 'Motivasi belajar tinggi, aktif di OSIS.',
    createdAt: '2026-06-10 13:15:00',
  ...
  },
  {
    ...
    nisn: '0067712345',
    nik: '1705011403060007',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 2,
    firstChoiceProdiName: 'S1 Informatika',
    secondChoiceProdiId: 3,
    secondChoiceProdiName: 'S1 Teknik Sipil',
    schoolOrigin: 'SMAN 1 Tais, Seluma',
    schoolType: 'SMA',
    schoolMajor: 'MIPA',
    graduationYear: 2026,
    phone: '082281903422',
    email: 'rizky.ilham@gmail.com',
    address: 'Pasar Tais RT 01/RW 01, Seluma',
    city: 'Seluma',
    province: 'Bengkulu',
    desil: 'Desil 2',
    parentName: 'Zulkifli',
    parentIncome: 1150000,
    parentJob: 'Buruh Perkebunan',
    familyDependents: 4,
    documentStatus: 'Lengkap',
    utbkScore: 82.0,
    interviewScore: 88.0,
    ...
    selectionStatus: 'Lulus',
    rank: 7,
    notes: 'Juara kelas peringkat 1 konsisten 3 tahun.',
    createdAt: '2026-06-11 16:00:00',
    updatedAt: '2026-08-20 14:25:00'
  },
  {
    id: 8,
    regNumber: 'KIPK-2026-0290',
    name: 'Putri Ayu Wandira',
    nisn: '0054321908',
    nik: '1704024806050008',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 12,
    firstChoiceProdiName: 'S1 Pendidikan Bahasa Inggris',
    secondChoiceProdiId: 11,
    secondChoiceProdiName: 'S1 Bimbingan dan Konseling',
    schoolOrigin: 'SMAN 1 Bintuhan, Kaur',
    schoolType: 'SMA',
    schoolMajor: 'Bahasa / IPS',
    graduationYear: 2025,
    phone: '085273419088',
    email: 'putri.wandira@gmail.com',
    address: 'Kaur Selatan RT 03/RW 01',
    city: 'Kaur',
    province: 'Bengkulu',
    desil: 'Desil 1',
    parentName: 'Abdullah',
    parentIncome: 850000,
    parentJob: 'Penyadap Karet',
    familyDependents: 5,
    documentStatus: 'Lengkap',
    utbkScore: 83.5,
    interviewScore: 86.0,
    ...
    selectionStatus: 'Lulus',
    rank: 8,
    notes: 'Kondisi geografis sangat terpencil di perbatasan Kaur-Lampung.',
    createdAt: '2026-06-12 10:40:00',
    updatedAt: '2026-08-20 14:28:00'
  },
  {
    id: 9,
    regNumber: 'KIPK-2026-0312',
    ...
    nisn: '0069921430',
    nik: '1706010909060009',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 4,
    firstChoiceProdiName: 'S1 Teknik Mesin',
    secondChoiceProdiId: 2,
    secondChoiceProdiName: 'S1 Informatika',
    schoolOrigin: 'SMKN 1 Mukomuko',
    schoolType: 'SMK',
    schoolMajor: 'Teknik Otomotif',
    graduationYear: 2026,
    phone: '081368921045',
    email: 'dimas.nugroho@gmail.com',
    address: 'Jl. Lintas Barat Sumatera KM 205, Penarik',
    city: 'Mukomuko',
    province: 'Bengkulu',
    desil: 'Desil 2',
    parentName: 'Joko Waluyo',
    parentIncome: 1300000,
    parentJob: 'Montir Bengkel Kecil',
    familyDependents: 4,
    documentStatus: 'Lengkap',
    utbkScore: 81.0,
    interviewScore: 85.0,
    ...
    selectionStatus: 'Lulus',
    rank: 9,
    notes: 'Sangat berminat pada permesinan & teknologi kelautan.',
    createdAt: '2026-06-14 09:30:00',
    updatedAt: '2026-08-20 14:30:00'
  },
  {
    id: 10,
    regNumber: 'KIPK-2026-0355',
    name: 'Anisa Rahmawati',
    nisn: '0061209845',
    nik: '1708015003060010',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 9,
    firstChoiceProdiName: 'S1 Administrasi Publik',
    secondChoiceProdiId: 1,
    secondChoiceProdiName: 'S1 Ilmu Hukum',
    schoolOrigin: 'SMAN 1 Kepahiang',
    schoolType: 'SMA',
    schoolMajor: 'IPS',
    graduationYear: 2026,
    phone: '085381023944',
    email: 'anisa.rahmawati@gmail.com',
    address: 'Tebat Karai, Kepahiang',
    city: 'Kepahiang',
    province: 'Bengkulu',
    desil: 'Desil 3',
    parentName: 'Ahmad Syafii',
    parentIncome: 1450000,
    parentJob: 'Petani Kopi',
    familyDependents: 3,
    documentStatus: 'Lengkap',
    utbkScore: 80.0,
    interviewScore: 86.0,
    ...
    selectionStatus: 'Lulus',
    rank: 10,
    notes: 'Keluarga petani kopi skala kecil di pegunungan Kepahiang.',
    createdAt: '2026-06-15 11:20:00',
    updatedAt: '2026-08-20 14:32:00'
  },
  {
    id: 11,
    regNumber: 'KIPK-2026-0378',
    ...
    nisn: '0068819023',
    nik: '1709012207060011',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 1,
    firstChoiceProdiName: 'S1 Ilmu Hukum',
    secondChoiceProdiId: 10,
    secondChoiceProdiName: 'S1 Ilmu Komunikasi',
    schoolOrigin: 'SMAN 1 Karang Tinggi, Bengkulu Tengah',
    schoolType: 'SMA',
    schoolMajor: 'IPS',
    graduationYear: 2026,
    phone: '082177440911',
    email: 'fajar.kurniawan@gmail.com',
    address: 'Ujung Karang RT 02, Bengkulu Tengah',
    city: 'Bengkulu Tengah',
    province: 'Bengkulu',
    desil: 'Desil 2',
    parentName: 'Kasim',
    parentIncome: 1200000,
    parentJob: 'Buruh Kebun',
    familyDependents: 4,
    documentStatus: 'Lengkap',
    utbkScore: 78.0,
    interviewScore: 84.0,
    surveyScore: 82.0,
    finalScore: 81.60,
    selectionStatus: 'Cadangan',
    rank: 11,
    notes: 'Masuk daftar cadangan prioritas ke-1.',
    createdAt: '2026-06-16 14:10:00',
    updatedAt: '2026-08-20 14:35:00'
  },
  {
    id: 12,
    regNumber: 'KIPK-2026-0402',
    name: 'Nabila Zahra Khairunnisa',
    nisn: '0062390145',
    nik: '1771046201060012',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 5,
    firstChoiceProdiName: 'S1 Manajemen',
    secondChoiceProdiId: 6,
    secondChoiceProdiName: 'S1 Akuntansi',
    schoolOrigin: 'SMA IT Iqra Kota Bengkulu',
    schoolType: 'SMA',
    schoolMajor: 'MIPA',
    graduationYear: 2026,
    phone: '081290334812',
    email: 'nabila.zahra@gmail.com',
    address: 'Jl. Adam Malik KM 8, Pagar Dewa',
    city: 'Kota Bengkulu',
    province: 'Bengkulu',
    desil: 'Desil 3',
    parentName: 'Syamsul Bahri',
    parentIncome: 1600000,
    parentJob: 'Pedagang Sayur Pasar',
    familyDependents: 3,
    documentStatus: 'Lengkap',
    utbkScore: 76.5,
    interviewScore: 83.0,
    ...
    selectionStatus: 'Cadangan',
    rank: 12,
    notes: 'Cadangan kuota FEB.',
    createdAt: '2026-06-18 10:00:00',
    updatedAt: '2026-08-20 14:37:00'
  },
  {
    id: 13,
    regNumber: 'KIPK-2026-0415',
    name: 'Hendra Gunawan',
    nisn: '0059901423',
    nik: '1703081105050013',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 8,
    firstChoiceProdiName: 'S1 Agribisnis',
    secondChoiceProdiId: 7,
    secondChoiceProdiName: 'S1 Agroteknologi',
    schoolOrigin: 'SMAN 1 Arga Makmur',
    schoolType: 'SMA',
    schoolMajor: 'IPA',
    graduationYear: 2025,
    phone: '085299881123',
    email: 'hendra.gunawan@gmail.com',
    address: 'Gunung Selan, Arga Makmur',
    city: 'Bengkulu Utara',
    province: 'Bengkulu',
    desil: 'Desil 4',
    parentName: 'Marzuki',
    parentIncome: 1900000,
    parentJob: 'Pekerja Swasta Lepas',
    familyDependents: 2,
    documentStatus: 'Lengkap',
    utbkScore: 74.0,
    interviewScore: 78.0,
    ...
    rank: 13,
    notes: 'Nilai dan desil di bawah passing grade KIP-K.',
    createdAt: '2026-06-20 09:10:00',
    updatedAt: '2026-08-20 14:40:00'
  },
  {
    id: 14,
    regNumber: 'KIPK-2026-0428',
    name: 'Rahmat Hidayatullah',
    nisn: '0061203499',
    nik: '1771011508060014',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 2,
    firstChoiceProdiName: 'S1 Informatika',
    secondChoiceProdiId: 4,
    secondChoiceProdiName: 'S1 Teknik Mesin',
    schoolOrigin: 'SMKN 2 Bengkulu',
    schoolType: 'SMK',
    schoolMajor: 'Teknik Komputer dan Jaringan',
    graduationYear: 2026,
    phone: '081373204918',
    email: 'rahmat.hidayat@gmail.com',
    address: 'Bentiring RT 05, Muara Bangkahulu',
    city: 'Kota Bengkulu',
    province: 'Bengkulu',
    desil: 'Desil 1',
    parentName: 'Sudarno',
    parentIncome: 900000,
    parentJob: 'Buruh Cuci Motor',
    familyDependents: 4,
    ...
    notes: 'Pendaftar baru, menunggu verifikasi berkas oleh Operator Pemberkasan.',
    createdAt: '2026-07-01 08:30:00',
    updatedAt: '2026-07-01 08:30:00'
  },
  {
    id: 15,
    regNumber: 'KIPK-2026-0430',
    name: 'Lestari Indah Pratiwi',
    nisn: '0067789012',
    nik: '1705035210060015',
    academicYearId: 1,
    academicYearCode: '2026/2027',
    firstChoiceProdiId: 11,
    firstChoiceProdiName: 'S1 Bimbingan dan Konseling',
    secondChoiceProdiId: 12,
    secondChoiceProdiName: 'S1 Pendidikan Bahasa Inggris',
    schoolOrigin: 'SMAN 2 Seluma',
    schoolType: 'SMA',
    schoolMajor: 'IPS',
    graduationYear: 2026,
    phone: '082381290311',
    email: 'lestari.pratiwi@gmail.com',
    address: 'Sukaraja, Seluma',
    city: 'Seluma',
    province: 'Bengkulu',
    desil: 'Desil 2',
    parentName: 'Supriadi',
    parentIncome: 1100000,
    parentJob: 'Tukang Kayu',
    familyDependents: 3,
    documentStatus: 'Perlu Perbaikan',
    utbkScore: 0,
    interviewScore: 0,
    surveyScore: 0,
    finalScore: 0,
    selectionStatus: 'Belum Diproses',
    notes: 'Surat Keterangan Tidak Mampu (SKTM) kadaluarsa, perlu re-upload.',
    createdAt: '2026-07-02 11:45:00',
    updatedAt: '2026-07-05 09:20:00'
  }
];
